  ...
  return <div style={{zIndex:999}} className={`${showSidebar  ?"hidden":"flex"}  xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed  `} id="navigation-container">
    ...
    <div className="flex flex-col justify-center space-y-4">
        ...
        <Link to="/cart" className="flex items-center transition-transform transform hover:translate-x-2">
            ...
            <div className="absolute top-9">
                {cartItems.length>0&&(
                    <span>
                        <span className="px-1 py-0 text-sm text-white rounded-full bg-pink-500">
    ...
    <div className="relative">
        <button onClick={toggleDropdown} className="flex items-center text-gray-800 focus:outline-none">
            ...
            {userInfo &&(<div className={`h-4 w-4 ml-1  ${dropdownOpen? "transform rotate":""}`}></div>)}
        </button>
            ...
            <ul className={`absolute right-0 mt-2 mr-14  space-y-2  bg-white text-gray-600 ${!userInfo.isAdmin? "-top-20": "-top-80"}`}>
                ...
                {userInfo.isAdmin && (
                    <>
                        ...
                        <li>
                            <Link to={`/admin/productlist`} className="block px-4 py-2 hover:bg-gray-100">Product lists</Link>
                        </li>

                        <li>
                            <Link to={`/admin/categorylist`} className="block px-4 py-2 hover:bg-gray-100">Category List</Link>
                        </li>
                        ...
                        <li>
                            <Link to={`/admin/userlist`} className="block px-4 py-2 hover:bg-gray-100">User List</Link>
                        </li>
